...
const highlights = [
  ['10년 9개월', '게임 시나리오·퀘스트·콘셉트 기획 경력'],
  ['약 370,000자', '단일 프로젝트 메인 퀘스트 전체 집필'],
  ['퀘스트 325개', '마술양품점 메인 챕터 6 제작'],
  ['파트 리드', '작업 방향 설정과 시나리오 품질 검수'],
]
...
const experience = [
  { period:'2020.11–2024.01', company:'스마일게이트 엔터테인먼트', role:'부책임 · 시나리오/퀘스트/콘셉트 기획', bullets:['마술양품점 설정 파트장으로 작업 방향 설정·관리 및 파트원 케어','메인 챕터 6 전체 시나리오와 퀘스트 325개 작성','프로젝트 B 대장장이·목축 직업 퀘스트 150여 개 작성'] },
  { period:'2017.05–2020.02', company:'슈퍼애시드', role:'리드 시나리오 기획 · 마기아: 카르마 사가', bullets:['프로젝트 기본 세계관과 캐릭터별 시나리오 설정','메인 퀘스트 전체 약 370,000자 및 일부 서브 퀘스트 작성','퀘스트 연출·데이터와 캐릭터·배경·몬스터 콘셉트 작업 리드'] },
...
function Resume(){
 ...
 return <main className="resume-page">
  ...
  <header className="resume-hero"><p className="resume-kicker">SENIOR GAME NARRATIVE DESIGNER</p><h1>강해님 <small>Hae-nim Kang</small></h1><p className="resume-role">시나리오 · 퀘스트 · 콘셉트 기획</p><p className="resume-summary">RPG부터 SNG와 샌드박스까지 다양한 장르에서 세계관과 캐릭터를 설계하고, 퀘스트를 실제 게임 데이터로 구현해 온 내러티브 기획자입니다.</p><div className="resume-contact"><a href="mailto:mingyun86@naver.com"><Mail/>mingyun86@naver.com</a><a href="https://blog.naver.com/spearsun" target="_blank" rel="noreferrer"><ExternalLink/>Naver Blog</a><span>서울시 은평구</span></div></header>
  ...
  <footer className="resume-footer"><span>© 2011-2024 Haenim Kang</span><a href={base}>Portfolio <ArrowUpRight/></a></footer>
 </main>
}
