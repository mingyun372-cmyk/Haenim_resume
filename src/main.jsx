...
const projects = [
  ...
  {year:'2014–2016', title:'언라이트 트리니티 · 로맨틱 프린세스', company:'글리터', genre:'캐주얼 TCG · 여성향 연애 시뮬레이션', tags:['외주 디렉팅','콘텐츠','교정·교열'], summary:'외부 작가 작업 관리와 시나리오 검수, 텍스트 교정·교열을 담당했습니다. 신규 캐릭터 가이드와 아이템 콘셉트, 튜토리얼·시네마 시스템, 더빙 대본까지 폭넓게 수행했습니다.', proof:'외주 관리 · 캐릭터 가이드 · 부분 보이스 대본'},
  {year:'2013–2014', title:'프로젝트 P/G/B', company:'위메이드', genre:'캐주얼 모바일', tags:['콘셉트','퀘스트','시스템'], summary:'모바일 프로젝트들의 세계관, 캐릭터, 배경, 퀘스트와 시스템 기획을 맡았습니다.', proof:'다장르 모바일 기획'},
  {year:'2011–2012', title:'드라고나 온라인', company:'라이브플렉스', genre:'MMORPG', tags:['시나리오','퀘스트'], summary:'드라고나 50–59레벨 업데이트의 메인 퀘스트 300여 개를 단독 제작·관리했습니다.', proof:'업데이트 퀘스트 300여 개'}
]
const skills = [
